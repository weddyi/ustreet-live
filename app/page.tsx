...
const QUESTIONS: Record<string, CategoryData> = {
  ...
  "🔥 Hot Takes": {
    color: "#ef4444",
    questions: [
      "If you're single past 35 it's not bad luck — it's a pattern you need to look at.",
      "Most people don't want a relationship. They want a witness to their life.",
      "Your 'type' is just a list of red flags you're comfortable with.",
      "People who say they're 'too real' are usually just rude with no filter.",
      "If your man has a female best friend who texts him every day, that's not a friend.",
      "The most dangerous person in your life is the one you keep making excuses for.",
      "Most people are one financial emergency away from losing everything and still acting bougie.",
      "You don't miss the person. You miss the version of yourself you were with them.",
      "Nobody actually wants equal effort in a relationship. Everyone wants to feel chosen.",
      "The reason your situationship is still going is because YOU want it to.",
      "If he wanted to, he would. Stop explaining his behavior.",
      "Women stay in bad relationships longer because society punishes them for being alone.",
      "Most men don't heal — they just find the next woman to perform for.",
      "Being busy is the most socially acceptable form of avoidance.",
      "You're not an introvert. You're just afraid of being perceived.",
      "The people who post the most about their relationship are the most insecure in it.",
      "Accountability without change is just a good apology.",
      "Most people's 'boundaries' are just punishments in disguise.",
      "You can tell everything about a person by how they treat someone who can do nothing for them.",
      "The smartest thing you can do financially is stop trying to look rich.",
      "Most people are not depressed. They're bored, purposeless, and disconnected — that's different.",
      "Your parents did the best they could — and their best might've still been traumatic. Both are true.",
      "The loudest person in the room is always the most insecure.",
      "People don't fear failure. They fear what people will say when they fail.",
      "If your circle isn't making you better, you don't have a circle — you have an audience.",
      "Most people stay in their hometown because growth is scarier than comfort.",
      "You will never be successful doing something you're only somewhat passionate about.",
      "The version of you that people see on Instagram would embarrass your real self.",
      "Everyone wants generational wealth but nobody wants to be the generation that sacrifices.",
      "The most radical thing you can do right now is just be honest.",
    ],
  },
  "🤐 Confessions": {
    color: "#ec4899",
